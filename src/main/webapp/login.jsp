...
<body>
    <div class="card">
        ...
        <% 
            Object errors = request.getAttribute("actionErrors");
            if (errors != null && ((Collection)errors).size() > 0) {
        %>
        ...
        <p style="margin-top: 1rem; font-size: 0.8rem; color: #8b949e;">
            New here? <a href="register.jsp" style="color: #58a6ff; text-decoration: none;">Register here</a>
        </p>
    </div>
</body>
</html>
